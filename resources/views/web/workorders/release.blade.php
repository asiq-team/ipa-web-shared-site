<x-app-layout>
    ...
    <x-slot name="script">
        ...
        <script>
            $(document).ready( function () {
                ...
                var table = $('#tableData').DataTable({
                   // responsive: true,
                    ...
                    "columnDefs": [
                        { "targets": 0, "className": "text-small text-center border-b", "data": "site", "render": function ( data, type, row, meta ){
                            return '<a href="javascript:;" onclick="show(\''+row["id"]+'\')"><div class="font-medium whitespace-no-wrap">'+data["name"]+'</div>'
                                    +' <div class="text-gray-600 text-xs whitespace-no-wrap">'+data["code"]+'</div></a>'
                        } },
                        { "targets": 1, "className": "text-small text-center border-b", "data": "floc_site", "visible": true },
                        { "targets": 2, "className": "text-small text-center border-b", "data": "periode", "render": function ( data, type, row, meta ){
                            return '<div class="font-medium whitespace-no-wrap">'+data["label"]+'</div>'
                        } },
                        { "targets": 3, "className": "text-xs text-center border-b", "data": "area", "visible": true },
                        { "targets": 4, "className": "text-xs text-center border-b", "data": "engineer", "visible": true },
                        { "targets": 5, "className": "text-center w-40 text-xs", "data": "tenant", "render": function ( data, type, row, meta ){
                        ...
                        { "targets": 6, "className": "text-center border-b w-5", "data": "workorder_id", "render": function ( data, type, row, meta ){
            ...
            function show(id){
                url_raw = "{{ route('tower.wo.release.show',['id'=>':id']) }}";
                url = url_raw.replace(':id',id)
                window.location = url
                //console.log(url)
            }
