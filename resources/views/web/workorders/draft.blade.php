                ...
                <x-top-bar>
                    <x-slot name="breadcrumb">
                        <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
                            ...
                            <a href="" class="">Draft</a>
                        </div>
                    </x-slot>
                </x-top-bar>
                <div class="col-span-12 mt-6">
                    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                        <h2 class="text-lg font-medium mr-auto">Work Order Draft Template</h2>
            ...
            $(document).ready( function () {
                ...
                var table = $('#tableData').DataTable({
                   // responsive: true,
                    ...
                    "columnDefs": [
                        { "targets": 0, "className": "text-small text-center border-b", "data": "batch", "visible": true },
                        { "targets": 1, "className": "text-small text-center border-b", "data": "site_name", "render": function ( data, type, row, meta ){
                        ...
                        { "targets": 2, "className": "text-small text-center border-b", "data": "floc_site", "visible": true },
                        { "targets": 3, "className": "text-small text-center border-b", "data": "plan", "render": function ( data, type, row, meta ){
                            if(data === "Monthly"){
                        ...
                        { "targets": 7, "className": "w-40", "data": "deleted_at", "render": function ( data, type, row, meta ){
                                    if(data === null){
                        ...
                        { "targets": 8, "className": "text-center border-b w-5", "data": "workorder_id", "render": function ( data, type, row, meta ){
