            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        <img alt="STP ASIQ PMTools" class="w-6" src="{{ asset('dist/images/logo.svg') }}">
                        <span class="text-white text-lg ml-3">
                            STP<span class="font-medium"> ASIQ</span>
                        </span>
                    </a>
                    <div class="my-auto">
                        <img alt="STP ASIQ PMTools" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/illustration.svg') }}">
                        <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Asset Integration and Quality <br> ASIQ</div>
                        <div class="-intro-x mt-5 text-lg text-white dark:text-gray-500">Aplikasi Work Order Management and Asset Monitoring System</div>
                    </div>
                </div>
                <!-- END: Login Info -->
                <!-- BEGIN: Login Form -->
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">Tower and FO Division Support</div>
                        <div class="intro-x mt-8">
                            <form id="login-form">
                                <input type="text" id="input-email" class="intro-x login__input input input--lg border border-gray-300 block" placeholder="Username atau Email" >
                        ...
                        <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                            <div class="flex items-center mr-auto">
                                ...
                                <label class="cursor-pointer select-none" for="input-remember-me">Tetap Login</label>
                            </div>
            ...
            cash(function () {
                async function login() {
                    ...
                    axios.post(`login`, {
                        ...
                        application_key: "HDqHtEWJAYmTRVu8Cf4wwppZATaLWIar"
                    }).then(res => {
                        location.href = '/'
                    }).catch(err => {
