...
<div class="top-bar">
        ...
        <div class="search-result">
            <div class="search-result__content">
                    ...
                    @foreach (array_slice($fakers, 0, 4) as $faker)
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Mustkenters" class="rounded-full" src="{{ asset('dist/images/' . $faker['photos'][0]) }}">
                            </div>
                ...
                @foreach (array_slice($fakers, 0, 4) as $faker)
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Mustkenters" class="rounded-full" src="{{ asset('dist/images/' . $faker['images'][0]) }}">
                        </div>
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in">
            <img alt="Mustkenters" src="{{ asset('dist/images/' . $fakers[9]['photos'][0]) }}">
        </div>
